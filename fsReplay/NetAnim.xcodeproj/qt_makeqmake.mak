...
QMAKE    = /usr/bin/qmake
NetAnim.xcodeproj/project.pbxproj: NetAnim.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o NetAnim.xcodeproj/project.pbxproj NetAnim.pro
