    ...
    def _disable_pytest_capture_maybe(self):
        ...
        try:
            ...
            pass # newer py.test with support ready, or very old py.test for
                 # which this debugger does not work
...
"""
    ...
    def _g_get_display_list(self):
        return g_display_list.setdefault(self.curframe, {})
	...
	self._g_get_display_list()[arg] = value
    ...
    def do_unwatch(self, arg):
        ...
        try:
            ...
            del self._g_get_display_list()[arg]
        except KeyError:
    ...
    def preloop(self):
        self._print_if_sticky()
        display_list = self._g_get_display_list()
