...
class DefaultConfig:
    ...
    stdin_paste = None       # for emacs, you can use epaste script
...
class Pdb(pdb.Pdb, ConfigurableClass):
    ...
    def parseline(self, line):
        ...
        # fsdb has "smart command mode": don't execute commands if a variable
        # with the name exits in the current context; this prevents pdb to quit
...
You can use ``hf_unhide`` to tell fsdb to ignore the hidden status (i.e., to
...
"""
    ...
    def do_track(self, arg):
        ...
        the current PYTHONPATH. This doesn't work for Ram as of now :-/
        """
        try:
